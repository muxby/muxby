...
| `assets/atelier/intro.svg` | Identity plate: molten M seal dripping onto a brass nameplate |
| `assets/atelier/postcard.svg` | Short calling card |
| `assets/atelier/wax-seal.svg` | Compact dripping monogram seal |
...
| `scripts/build_intro.py` | Regenerates the intro identity plate and dripping wax seal |
...
Hand-drawn pieces (roadmap, trail, corkboard, desk, signature) are plain SVG
...
The intro identity plate and wax seal are generated by `python3 scripts/build_intro.py`.
